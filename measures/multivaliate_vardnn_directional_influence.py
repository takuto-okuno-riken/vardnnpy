# -*- coding: utf-8 -*-
##
# Calculate mVARDNN (multivaliate Vector Auto-Regressive Deep Neural Network) DI
# returns mVARDNN DI matrix (DI)
# input:
...
class MultivariateVARDNNDirectionalInfluence(object):
    def __init__(self):
        self
    ...
    def plot(self, net=[], node_control=[], ex_control=[], is_full_node=0):
        ...
        plt.matshow(di_mat)
#        plt.axis('off')
        plt.title('Multivariate VARDNN Directional Influence')
        plt.colorbar()
