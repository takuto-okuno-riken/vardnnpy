# -*- coding: utf-8 -*-
##
# Calculate multivariate PCVAR Granger Causality
# returns mPCVAR Granger causality index (gc_mat)
# input:
...
class MultivariatePCVARGrangerCausality(object):
    def __init__(self):
        self
    ...
    def calc(self, x, ex_signal=[], node_control=[], ex_control=[], net=[], is_full_node=0):
        ...
        for i in range(node_num):
            ...
            for j in range(node_max):
                ...
                pred = net.lr_objs[i].predict(feature[:, 0:net.max_comps[i]])
                xr = (yi - pred)
    ...
    def plot(self, x, ex_signal=[], node_control=[], ex_control=[], net=[], is_full_node=0):
        ...
        plt.matshow(gc_mat)
#        plt.axis('off')
        plt.title('Multivariate PCVAR Granger Causality')
        plt.colorbar()
